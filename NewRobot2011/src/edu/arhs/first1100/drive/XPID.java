...
public class XPID extends PID
{
    ...
    public void tick()
    {
         if (cs.getCenterX() > 0)
         {
             ...
             System.out.println("Camera X-PID: camera off center : right");
         }
         if (cs.getCenterX() < 0)
         {
             ds.setTankSpeed (0.2, 0.4);
             System.out.println("Camera X-PID: camera off center : left");
         }
         else
         {
             ds.setTankSpeed(0.0, 0.0);
             System.out.println("Camera X-PID: camera centered");
         }
    }
